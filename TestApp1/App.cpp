...
public:
   ...
   void Init ( ) {
      ...
      CButtonUI * btn = ( CButtonUI * ) m_pm.FindControl ( _T ( "bt1" ) );
      btn->SetButtonImage ( _T ( "Button\\btn.png" ), 4, false );
      btn->SetButtonImage ( _T ( "bt1.png" ), 4 );
      btn->SetButtonImage ( _T ( "Button\\Switch_B.png" ), 4 );
